...
const Home = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 md:px-20'>
            ...
            <div className='w-full lg:w-2/3'><Lottie animationData={study1} loop={true}></Lottie></div>
            <div className='w-full lg:w-2/3'><Lottie animationData={study} loop={true}></Lottie></div>
            <div className='flex flex-col items-center justify-center'>
