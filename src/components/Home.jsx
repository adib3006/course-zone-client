    ...
    return (
        <div className='grid grid-cols-2 px-20'>
            <div className='flex flex-col items-center justify-center'>
                <h2 className='text-3xl text-center font-medium'>Make your dream come true with our top of the line tech courses.</h2>
                <p className='text-xl'>choose from our courses.</p>
            ...
            <div className='flex flex-col items-center justify-center'>
                <h2 className='text-3xl text-center font-medium'>Take guidelines from our best instructors and develop your skills from home.</h2>
                <p className='text-xl'>choose from our courses.</p>
                <Link className='px-4 py-1 m-4 hover:shadow font-semibold rounded-md bg-sky-900 hover:bg-sky-700 hover:text-white text-gray-100'  to='/courses'>Courses</Link>
            </div>
        </div>
